    ...
    ) : IRequestHandler<UpdateUserCommand, Result<string>>
{
    public async Task<Result<string>> Handle(UpdateUserCommand request, CancellationToken cancellationToken)
    {
        ...
        if(user.Email != request.Email)
        {
            ...
            {
                return Result<string>.Failure("Bu Email Kullanılmaktadır");
            }
        }
        ...
        if(user.UserName != request.UserName)
        {
            ...
            {
                return Result<string>.Failure("Bu Kullanıcı adı kullanılmaktadır");
            }
        }
        ...
        return "Kullanıcı Güncelleme İşlemi Başarılı";
    }
}
